...
excerpt: "An explanation of the support vector machine, with discussions regarding the primal- and dual problem, as well as the soft-margin SVM, kernelized SVM and SVO algorithm."
header: 
