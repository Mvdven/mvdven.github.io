...
sidebar:
  ...
  nav: sidebar-SVM
gallery1:
  - url: /images/possible-decision-boundaries-1
    image_path: /images/possible-decision-boundaries-1.png
    title: First example of linear decision boundary
  - url: /images/possible-decision-boundaries-2
    image_path: /images/possible-decision-boundaries-2.png
    title: Second example of linear decision boundary
---
...
{% include gallery id="gallery2" class="full" caption="Different possible linear seperators." %}
