...
<font size="6"><b>  Chapter 5: SMO algorithm </b></font>
---
...
\begin{equation}
\begin{array}{rrclcl}
\displaystyle \max_{\alpha_1, \alpha_2} & \alpha_1 + \alpha_2  - \frac{1}{2}  (\alpha_1^2 K_{11} +   \alpha_2^{2} K_{22} + 2a_{1}a_{2}y^{(1)}y^{(2)}K_{12}) - \alpha_1 y^{(1)} \sum_{j \neq 1, 2}^{m}  \alpha_j y^{(j)} K_{1j} - \alpha_2 y^{(2)} \sum_{i \neq 1, 2}^{m} \alpha_i y^{(i)} K_{i2} \tag{5-2} \label{5-2} \newline
...
\begin{align}
\upsilon_{k} & = \sum_{i\neq 1,2} ^{m} \alpha_i y^{(i)} K_{ik}  \tag{5-5} \newline
...
\begin{align}
L(\alpha_2) & = [\zeta - s \alpha_2] + \alpha_2 - \frac{1}{2}  ([\zeta - s \alpha_2]^2 K_{11} +   \alpha_2^{2} K_{22} + 2 [\zeta - s \alpha_2] \alpha_{2}y^{(1)}y^{(2)}K_{12}) - [\zeta - s \alpha_2]  y^{(1)} \upsilon_1 - \alpha_2 y^{(2)} \upsilon_2 \tag{5-7} \newline
...
&\quad = \zeta + \alpha_{2}(1-s) - \frac{1}{2} \zeta^{2} K_{11} + s \alpha_{2} \zeta K_{11} - \frac{1}{2} s^{2} \alpha_{2}^2 K_{11} - \frac{1}{2} \alpha_{2}^{2} K_{22} - \zeta \alpha_{2} s K_{12} + \alpha_{2}^{2} s^{2} K_{12} - \zeta y^{(1)} \upsilon_{1} + s \alpha_{2} y^{(1)} \upsilon_{1} - \alpha_{2} y^{(2)} \upsilon_{2} \newline
...
\begin{align}
\eta = 2K_{12} - K_{11} - K_{22} \Leftrightarrow 2z_{1}^Tz_{2} - z_{1}^Tz_{1} - z_{2}^Tz_{2} \Leftrightarrow -(z_{1}^T-z_{2}^{T}) (z_{1} - z_{2}) \Leftrightarrow -(z_{1}-z_{2})^T(z_{1}-z{2}) \Leftrightarrow - \|z_{1}-z_{2}\|^{2} \leq 0 \tag{5-9} \label{5-9}
\end{align}
...
\begin{align}
&\quad{} = 1 - s + \zeta s (K_{11} - K_{12}) +  y^{(2)} (\upsilon_{1} - \upsilon_{2}) \tag{5-10} \newline
...
\begin{align}
L{\alpha_2} = [\frac{1}{2} \eta] \alpha^{2}_{2} + [y^{(2)} (E_{1} - E_{2}) - \alpha_{2}^{old} \eta] \alpha_{2}  \tag{5-11} \label{5-11}
\end{align}

To maximize the objective function, we consider the first- and second order derivative as follows:

\begin{align}
\frac{\delta}{\delta \alpha_2} L{\alpha_2} & = \eta \alpha_{2} + y^{(2)} (E_{1} - E_{2}) - \alpha_{2}^{old} \eta \tag{5-12}\\
\frac{\delta^{2}}{\delta^{2} \alpha_2} L{\alpha_2} & = \eta \leq 0 \tag{5-13} \label{5-13}
\end{align}
...
### 5.2 Clipping optimal parameters
